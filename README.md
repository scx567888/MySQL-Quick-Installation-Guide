...
#### 2, 如果没有 `data` 目录, 则需要进行 [初始化](https://dev.mysql.com/doc/refman/8.2/en/data-directory-initialization.html) (你会获得一个 `临时密码`) .
...
- 完整版 [MySQL 安装指南](https://dev.mysql.com/doc/mysql-installation-excerpt/8.2/en/windows-install-archive.html) .
